...
$(function() {
    ...
    var options = {
        center: {lat: 48.8448, lng: 2.3471}, // Cambridge, Massachusetts
  ...
  google.maps.event.addListener(marker, 'click', function(e){
        ...
        .done(function(data, textStatus, jqXHR){
            ...
            for (var i = 0; i<len; i++){
                ...
                articles += "<div><a href=\"" + content[i].link +"\" target=\"_blank\">"
                +content[i].title+"</div>";
                }
...
function changelang()
{
    document.getElementById("button1").addEventListener("click", function(){$getJSON(articles.php)   
}); 
}
